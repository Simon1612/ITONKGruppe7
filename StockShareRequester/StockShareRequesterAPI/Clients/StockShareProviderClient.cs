...
namespace StockShareRequesterAPI.Clients
{
    ...
    public partial class StockShareProviderClient 
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<AvailableSharesDataModel>> ApiStockShareProviderGetSharesForSaleGetAsync(System.Guid? userId)
        {
            return ApiStockShareProviderGetSharesForSaleGetAsync(userId, System.Threading.CancellationToken.None);
        }
    
        /// <returns>Success</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<AvailableSharesDataModel>> ApiStockShareProviderGetSharesForSaleGetAsync(System.Guid? userId, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/StockShareProvider/GetSharesForSale");
